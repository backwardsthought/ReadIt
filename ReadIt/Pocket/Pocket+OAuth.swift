...
class OAuth {
    ...
    static func authorizeURL(code: String) throws -> URL {
        var components = URLComponents()
        components.scheme = "https"
        components.host = "getpocket.com"
	...
	func authorizeURL() throws -> URL {
		...
		return try OAuth.authorizeURL(code: code)
	}
    
    static func authenticateURL(code: String) throws -> URL {
        var components = URLComponents()
        components.scheme = "https"
        components.host = "getpocket.com"
    ...
    func authenticateURL() throws -> URL {
		...
		return try OAuth.authenticateURL(code: code)
	}
